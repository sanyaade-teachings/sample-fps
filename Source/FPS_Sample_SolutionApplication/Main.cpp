...
#include "FPS_Sample_SolutionApplicationPCH.h"
...
{
public:
  FPS_Sample_SolutionApplicationClass() {}
  virtual ~FPS_Sample_SolutionApplicationClass() {}
...
VAPP_IMPLEMENT_SAMPLE(FPS_Sample_SolutionApplicationClass);

void FPS_Sample_SolutionApplicationClass::SetupAppConfig(VisAppConfig_cl& config)
{
...
void FPS_Sample_SolutionApplicationClass::PreloadPlugins()
{
...
//---------------------------------------------------------------------------------------------------------
void FPS_Sample_SolutionApplicationClass::Init()
{
...
//---------------------------------------------------------------------------------------------------------
void FPS_Sample_SolutionApplicationClass::AfterSceneLoaded(bool bLoadingSuccessful)
{
