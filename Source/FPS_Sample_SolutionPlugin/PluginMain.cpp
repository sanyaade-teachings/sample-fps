...
#include "FPS_Sample_SolutionPluginPCH.h"
...
//============================================================================================================
class FPS_Sample_SolutionPluginClass : public IVisPlugin_cl
{
public:
  ...
  {
    return "FPS_Sample_SolutionPlugin";  // must match DLL name
  }
};

//  global plugin instance
FPS_Sample_SolutionPluginClass g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_FPS_Sample_SolutionPlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_FPS_Sample_SolutionPlugin();}
...
void FPS_Sample_SolutionPluginClass::OnInitEnginePlugin()
{
  hkvLog::Info("FPS_Sample_SolutionPluginClass:OnInitEnginePlugin()");
...
void FPS_Sample_SolutionPluginClass::OnDeInitEnginePlugin()
{
  hkvLog::Info("FPS_Sample_SolutionPluginClass:OnDeInitEnginePlugin()");
